...
const translations = {
    ...
    uz: {
        ...
        institutionUz: 'Ta\'lim muassasasi nomi (UZ)',
        institutionRu: 'Ta\'lim muassasasi nomi (RU)',
        qualificationUz: 'Yo\'nalish (UZ)',
        qualificationRu: 'Yo\'nalish (RU)',
        close: 'Yopish',
        validationError: 'Iltimos, barcha maydonlarni to\'ldiring.',
    },
};
